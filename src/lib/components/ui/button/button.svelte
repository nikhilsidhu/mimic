	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-border dark:bg-input/30 hover:border-hover hover:text-hover aria-expanded:bg-muted aria-expanded:text-foreground",
				secondary: "bg-secondary text-secondary-foreground hover:text-hover aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
				ghost: "hover:bg-transparent hover:text-hover aria-expanded:bg-muted aria-expanded:text-foreground",
			...
			size: {
				...
				icon: "icon-glow size-7 [&_svg:not([class*='size-'])]:size-3.5",
				"icon-xs": "icon-glow size-5 rounded-sm [&_svg:not([class*='size-'])]:size-2.5",
				"icon-sm": "icon-glow size-6 [&_svg:not([class*='size-'])]:size-3",
				"icon-lg": "icon-glow size-8 [&_svg:not([class*='size-'])]:size-4",
			},
		},
		defaultVariants: {
			variant: "default",
